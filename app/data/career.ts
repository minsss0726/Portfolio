...
export interface CareerItem {
  ...
  description?: {
    ...
    contribution: string;
    /** 주요 업무 및 상세 역할 (역할별 구분) */
    tasksByRole?: {
      backend?: string[];
      frontend?: string[];
      infrastructure?: string[];
    };
    /** @deprecated tasksByRole 사용 권장. 기술 아이콘용 평탄 목록 */
    tasks?: string[];
  };
}
    ...
    description: {
      ...
      tasksByRole: {
        backend: [
          ...
          "JPA를 통한 RDBMS(MariaDB) 연동",
          "File 업로드/다운로드 등 서버 파일 관리에 대한 기능 구현",
        ],
        frontend: [
          "Thymeleaf 기반의 프론트엔드 개발",
          "Google Analytics 4 연동을 통한 웹 방문자 수 차트 표시",
          "채널톡 연동을 통한 사용자-관리자 소통 연결",
          "JavaScript/jQuery 기반의 요청/응답 구현",
          "Quill Editor 라이브러리를 활용한 게시물 작성 기능 구현",
        ],
        infrastructure: ["Ngnix를 활용한 Gradle 빌드 기반의 서버 배포"],
      },
    },
  },
];
